...
1. In 1-2 sentences, explain what React's useRouteMatch hook is used for.
	...
	The useRouteMatch hook returns the match object. It also matches the URL exactly like a <Route> would, including the exact, strict and sensitive options.  

2. How would you explain form validation to someone who has never programmed before?

Form validation is a way to make sure the form is being filled out correctly.  You would get an error message if field on the form is not filled our correctly.  Therefore, the user does not have to fill out the form completely and try to figure out why the form is not going thru.  

3. In 1-2 sentences, define end to end testing.

End to end testing is used to test whether the flow of an application is performing as designed from beginning to completion. It is used to identify system dependencies and to ensure that the right information is passed between various system components and systems.
